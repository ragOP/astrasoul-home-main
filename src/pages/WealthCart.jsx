  ...
  const [cartItems, setCartItems] = useState([
    {
      ...
      description:
        "Unlock the secrets to your financial success with our comprehensive wealth report.",
      price: 499,
      originalPrice: 9999,
      duration: "45 minutes",
      features: [
        ...
        "Astrological insights for financial growth",
        "Actionable steps to achieve financial goals",
      ],
      image: "/astro.jpg",
    },
  ]);
      ...
      <section className="relative pt-12">
        <div className="max-w-7xl mx-auto">
          ...
          {cartItems.length === 0 ? (
            ...
            <>
              {/* WealthCart Items - Mobile Layout (unchanged) */}
              <div
