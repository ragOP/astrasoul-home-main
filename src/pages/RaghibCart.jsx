 ...
 const [cartItems, setCartItems] = useState([
  {
    ...
    features: [
      ...
      "Pyrite — clears financial blocks & boosts abundance",
    ...
    try {
      ...
      const options = {
        ...
        handler: async function (response) {
          try {
            await axios.post(`${BACKEND_URL}/api/lander21/create-order`, {
              amount: total,
            ...
            navigate("/order-confirmationbracelet", {
              state: {
                orderId: data.orderId,
                amount: total,
              },
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 selection:bg-purple-500/20 selection:text-white"
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(168,85,247,0.12),transparent_55%)]"></div>
          ...
          {cartItems.length === 0 ? (
            ...
            >
              <div className="relative group">
                <div className="absolute -inset-1 bg-gradient-to-r from-purple-500/25 via-pink-500/20 to-yellow-500/20 rounded-3xl blur-xl group-hover:blur-2xl transition-all duration-500"></div>
                <div className="relative bg-gradient-to-br from-white/[0.06] to-white/[0.03] backdrop-blur-xl rounded-3xl p-6 sm:p-8 border border-white/20">
                  <div className="text-center space-y-4 sm:space-y-6">
                    ...
                    <Link
                      to="/home"
                      className="inline-block bg-gradient-to-r from-purple-600 via-pink-600 to-yellow-500 text-white px-6 sm:px-8 py-2 sm:py-3 rounded-full font-semibold hover:from-purple-700 hover:via-pink-700 hover:to-yellow-600 transition-all duration-300 transform hover:scale-105 buy-now-shimmer text-sm sm:text-base shadow-[0_12px_40px_rgba(168,85,247,0.35)]"
                    >
