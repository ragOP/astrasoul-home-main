    ...
    <div className="relative group">
      ...
      <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-3xl p-4 border border-white/20">
        <div className="flex flex-col gap-4 sm:gap-6">
          ...
          <div className="flex flex-row gap-4 sm:gap-6 items-start">
            ...
            <div className="flex-shrink-0">
              <div className="relative group">
                ...
                {/* ✅ MOBILE FIXES:
                    - force a stable square size on mobile (w-20/h-20)
                    - prevent image overflow (overflow-hidden)
                    - keep border/padding but not too large on mobile (p-1.5)
                */}
                <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-2xl p-1.5 sm:p-2 border border-white/20 overflow-hidden w-20 h-20 sm:w-auto sm:h-auto">
                  <img
                    src={item.image}
                    alt={item.name}
                    className="w-full h-full sm:w-32 sm:h-32 object-cover rounded-xl"
                    loading="lazy"
                  />
                </div>
              </div>
            ...
            <div className="flex-1 flex flex-col min-w-0">
              <div className="flex justify-between items-start mb-2">
                <h3
                  className="text-2xl sm:text-3xl font-bold text-white pr-3"
                  style={{
                    display: "-webkit-box",
                    WebkitLineClamp: 3,
              ...
              <div className="flex items-center space-x-2">
                <span className="text-base sm:text-lg text-red-300 font-medium">
                  ⏱️ {item.duration}
                </span>
              </div>
            </div>
          ...
          <div className="flex items-center space-x-2">
            <p className="text-base sm:text-lg text-white/70 line-clamp-2">
              {item.description}
            </p>
          </div>

          {/* Middle Stack: What's Included */}
          <div className="space-y-4">
            <h4 className="text-base sm:text-lg font-semibold text-red-300">
              What's Included:
            </h4>
